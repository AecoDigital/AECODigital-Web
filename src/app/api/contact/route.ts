  ...
  const { error } = await resend.emails.send({
    ...
    html: `
      <div style="font-family:sans-serif;max-width:600px;margin:0 auto">
        <h2 style="color:#00E5A3;border-bottom:1px solid #e5e7eb;padding-bottom:12px">
        ...
        <table style="width:100%;border-collapse:collapse">
          ...
          <tr><td style="padding:8px 0;color:#6b7280">Email</td><td style="padding:8px 0"><a href="mailto:${email}" style="color:#00E5A3">${email}</a></td></tr>
