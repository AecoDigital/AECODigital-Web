        ...
        <main className="pt-28 pb-24 px-6 min-h-screen">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex items-center gap-2 text-xs text-gray-400 mb-8">
              <Link href="/" className="hover:text-[#00E5A3] transition-colors">{bp.breadcrumbHome}</Link>
              <span>/</span>
              <span className="text-[#F4F6F9]">{bp.breadcrumbSection}</span>
            </div>

            {/* Header */}
            <div className="mb-12">
              <h1 className="text-4xl md:text-5xl font-bold text-[#F4F6F9] mb-4">{bp.title}</h1>
              <p className="text-gray-300 max-w-2xl">{bp.subtitle}</p>
            </div>
                ...
                {filtrados.map((articulo) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <h2 className="font-semibold text-[#F4F6F9] leading-snug mb-3 group-hover:text-[#00E5A3] transition-colors flex-1">
                        {titulo}
                      </h2>
